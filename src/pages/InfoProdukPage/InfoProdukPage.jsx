        ...
        <div className="col-lg-4">
            <div className="card" id='produk-card' style={{ padding:"16px 24px", boxShadow:"0px 0px 10px rgba(0, 0, 0, 0.15)", borderRadius: "16px"}}>
                ...
                <div className='p-0 m-0'>
                    <button className=" w-100" style={{ backgroundColor: "#181818", color: "#FFFF" , borderRadius: "16px" , padding : "10px 20px" , fontSize:"14px" }} type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" >Saya Tertarik dan Ingin Nego</button>
                </div>
            </div>
